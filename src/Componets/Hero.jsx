                ...
                <div className="flex flex-row flex-wrap items-center mx-[-12px] lg:pt-[120px] sm:pt-[100px] pt-[50px]">
                    <div className="w-full md:w-1/2 px-3" data-aos="flip-up">
                        ...
                        <div className="flex gap-8 items-center max-sm:flex-col max-sm:gap-4 mt-8">
                            <a href="../Assets/pdf/resume.pdf" download={"resume.pdf"}> <button className='bg-[#55E6A5]  font-popins px-6 py-1 transition duration-300 flex items-center mt-5 hover:bg-[#09101A] hover:text-white hover:scale-110 border-[1px] border-tranparent max-sm:px-2 max-sm:py-0  hover:border-[#55E6A5]'>
